    ...
    <div className="flex items-center justify-between p-6 mb-6 bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-xl border border-gray-200/50 dark:border-gray-700/50 shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-sm text-gray-500 dark:text-gray-400">Level {level || 1}</span>
        </div>
      </div>
      <Badge variant="secondary" className="flex items-center gap-2 px-4 py-2 bg-purple-50 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 border border-purple-200/50 dark:border-purple-700/50">
